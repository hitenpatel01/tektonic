...
@Component({
  selector: 'app-maturity-ladder',
  imports: [AgGridAngular],
  template: `
    <header class="panel-header">
      <div class="panel-title">Maturity Ladder</div>
...
export class MaturityLadderComponent {
  ...
  protected readonly rowData = computed(() =>
    [...this.allInstruments()].sort((a, b) => a.maturity.localeCompare(b.maturity)),
  );
  ...
  protected readonly colDefs: ColDef<Instrument>[] = [
    { field: 'maturity', filter: 'agTextColumnFilter', minWidth: 90, pinned: 'left', sort: 'asc' },
    { field: 'ticker', filter: 'agTextColumnFilter', minWidth: 130 },
    { field: 'issuer', filter: 'agTextColumnFilter' },
